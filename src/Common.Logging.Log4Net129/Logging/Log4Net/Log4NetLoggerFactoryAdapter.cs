...
#else
			/// <summary>Calls <see cref="XmlConfigurator.Configure(System.IO.FileInfo)"/> as Log4net in Android does not yet support FileWatches</summary>
#endif
